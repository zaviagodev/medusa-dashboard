...
var Header = () => {
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "w-full p-3", children: [
    ...
    /* @__PURE__ */ jsx14(Link3, { to: "https://b2b-demo.zaviago.com", target: "_blank", children: /* @__PURE__ */ jsxs9(Button2, { variant: "secondary", className: "w-full mt-2", children: [
      t2("app.nav.main.viewb2bStore"),
      /* @__PURE__ */ jsx14(Window, { className: "mt-[3.2px]" })
    ] }) })
  ] });
};
          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-YURC75NQ.mjs")
                    },
                    {
                      path: "import",
                      lazy: () => import("./product-import-B3QVIVLB.mjs")
                    },
                    {
                      path: "export",
                ...
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-5BSW6KMX.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-5BSW6KMX.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-6Z2YCZB6.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-I7Q5FB5K.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-TAEK5NIV.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-DKFUB3ZX.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-EFGXQR6D.mjs")
                        },
                        {
                          path: "prices",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-6WVNX54G.mjs")
                },
                {
                  path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-RQSKRKVR.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-KFQNWLVX.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-ALSR7LLU.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-D25WRCCH.mjs")
                    }
                  ]
                },
                {
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/login",
              lazy: () => import("./login-34273UVA.mjs")
            },
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-AFKWC5NN.mjs")
            },
            {
              path: "/invite",
              lazy: () => import("./invite-UTASLO4P.mjs")
            },
            {
              path: "*",
