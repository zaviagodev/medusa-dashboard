          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-RZMRYPAK.mjs")
                    },
                    {
                      path: "import",
                ...
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-B4DQ6334.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-B4DQ6334.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-F3PNPEHP.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-EX7VW32J.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-KHUBKPKX.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-3GWPOL2S.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-GNTRRPDG.mjs")
                        },
                        {
                          path: "prices",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-HR4RLDJT.mjs")
                },
                {
                  path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-BHMMMPVQ.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-W2XJXLF5.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-Y7MSKRJQ.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-NQSZSWJP.mjs")
                    }
                  ]
                },
                {
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-JAIE7Z5V.mjs")
            },
            {
              path: "/invite",
