          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-NBXU6AGQ.mjs")
                    },
                    {
                      path: "import",
                ...
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-XZSKXBG7.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-XZSKXBG7.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-5NRERYP4.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-AYHUUFKF.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-4ZBCRYG6.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-J5KYQCFV.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-URRVD4TB.mjs")
                        },
                        {
                          path: "prices",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-ZWUFTQNL.mjs")
                },
                {
                  path: "create",
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-RCXA6RDV.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-I25WH4XQ.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-P6GILA7I.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-TUNH2HVF.mjs")
                    }
                  ]
                },
                {
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-EYPZC2UZ.mjs")
            },
            {
              path: "/invite",
